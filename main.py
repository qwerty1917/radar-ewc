...
from exp_trainer import exp_DCNN
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_period', default=5, required=True, type=int, help='how often measure evaluation')
    parser.add_argument('--measure_fwt', default=False, required=True, type=str2bool, help='Add FWT measure to result log')
    ...
    parser.add_argument('--subject_seed', default=1, type=int, help='subject shuffle seed')
    ...
    parser.add_argument('--continual', default='', type=str, required=True, help='continual learning method',
                        choices=['ewc', 'hat_ewc', 'ewc_online', 'imm-mode',
                                 'si', 'l2', 'ucl', 'mas', 'gem', 'er', 'none'])
